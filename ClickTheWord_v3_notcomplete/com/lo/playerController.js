...
function InitActivity(){		
	...
	GData.JData = JSON.parse(JSON.stringify(JData));
	GData.MaxScreen = GData.JData.length;
	for(var i=0; i<GData.MaxScreen; i++){
		ShuffleArray(GData.JData[i].ArrOpt);
	}
...
function LoadScreen(ScrNo){	
	...
	switch(ScrNo){
		case 0:
			...
			break;
		case 1:
			ShowDiv("DvScr1"); GData.CurrScrNo = 1;
			break;
		case 2:
			ShowDiv("DvScr2"); GData.CurrScrNo = 2;
			break;
		default:
			ShowDiv("DvScr3"); GData.CurrScrNo = 0;
			break;
	}
}
